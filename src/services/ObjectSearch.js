...
export default class ObjectSearch {
    static async fetchObjectSearch(obj) {
        return $api.post('v1/objectsearch/histograms', {
          "issueDateInterval": {
        ...
        // {
        //   issueDateInterval: {
        //     startDate: new Date(obj.dateStart),
        //     endDate: new Date(obj.dateEnd)
        //   },
        //   searchContext: {
        //     targetSearchEntitiesContext: {
        //       targetSearchEntities: [
        ...
        //           inn: +obj.inn,
        //           maxFullness: obj.checkbox1 === "on" ? true : false,
        //           inBusinessNews: obj.checkbox2 === "on" ? true : false
        //         }
        //       ],
        //       onlyMainRole: obj.checkbox3 === "on" ? true : false,
        //       tonality: obj.tonality,
